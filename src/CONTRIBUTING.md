...
* Make sure you get the latest version of the code and run through the [Getting Started](https://github.com/CajetanRodrigues/covid-tracker#getting-started) steps to see if this resolves your issue.
...
* Maintain CamelCase wherever applicable.
* Always make sure the indent is perfect. Make use of linting packages
* Write your code in a modular format.
